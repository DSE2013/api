...
import com.xebia.wartelist.web.HospitalController;
...
privileged aspect HospitalController_Roo_Controller {
    ...
    @Autowired
    HospitalEmployeeService HospitalController.hospitalEmployeeService;
    
    @Autowired
    TimeSlotService HospitalController.timeSlotService;
